...
func proc2type(t string) int {
	fmt.Println("proc2type", t)
	switch {
	case t == PROC_TCP:
		return TCP
	case t == PROC_TCP6:
	...
	return 0 // it should never happened
}

func netstat(t string, sockets *map[string]Socket) {
...
func (this *Stats) FindByInodes(inodes []string) []Socket {
	sockets := []Socket{}
	for _, inode := range inodes {
		s, _ := this.sockets[inode]
